...
export let mode: Writable<'view' | 'edit' | 'create' | 'modify' | 'storage'> = writable('view');
...
export let translationProgress: Writable<
	{ [key: string]: { total: Set<any>; translated: Set<any> } } | { show: boolean }
> = writable({
	show: false
});
