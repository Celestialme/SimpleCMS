					...
					>
						<section class="p-4 text-center">
							{#if image.path.endsWith('.pdf')}
								<!-- PDF icon -->
								<!-- ... Add PDF icon code here ... -->
							{:else if image.path.endsWith('.xlsx') || image.path.endsWith('.xls')}
								<!-- Excel icon -->
								<!-- ... Add Excel icon code here ... -->
							{:else if image.path.endsWith('.docx') || image.path.endsWith('.doc')}
								<!-- Word icon -->
