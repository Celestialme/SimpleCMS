		...
		{:else}
			...
			<div class="flex items-center gap-4">
				...
				<button
					type="submit"
					on:keydown
					on:click={() => (columnShow = !columnShow)}
					class="variant-ghost-surface btn-icon mr-1"
				>
		...
		{:else}
			<div class="p-2">
				{#if columnShow}
					<!-- chip column order -->
					<div
						class="rounded-b-0 flex flex-col justify-center rounded-t-md border-b bg-surface-700 text-center"
