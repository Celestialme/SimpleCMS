<script lang="ts">
	...
	// Use the native JavaScript equivalent for the `last` function
	const last = (array) => array[array.length - 1];

	// Use the native JavaScript `startsWith` method for strings
	const startsWith = (string, searchString) => string.startsWith(searchString);
