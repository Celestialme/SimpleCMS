...
<div class="input-group grid-cols-[auto_1fr_auto]">
	<!-- prefix -->
	{#if field.prefix}
		<div class="!pr-0 text-surface-600 dark:text-surface-200 sm:!pr-[1rem]">{field.prefix}</div>
	{/if}
	...
	<!-- suffix -->
	{#if field.suffix}
		<span class="self-center pr-2 text-surface-600 dark:text-surface-200">{field.suffix}</span>
	{/if}
</div>
...
<p class="text-center">
	...
	<span class="text-primary-500">{formattedValue}</span>
</p>
